...
package com.modestmaps
{
	...
	public class Map extends Sprite
	{
		...
		*/
		public function Map(width:Number=320, height:Number=240, draggable:Boolean=true, provider:IMapProvider=null, extent:MapExtent=null)
		{
			if(provider==null) provider = new MicrosoftHybridMapProvider();
			if(extent==null) extent = new MapExtent(85, -85, 180, -180);
...
//			trace(new Error().getStackTrace());
		...
		*/
		...
		{
			var distance:Number = -__height / 3;
